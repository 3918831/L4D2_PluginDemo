...
//#endif
	...
	// 这段代码用于绘制hitbox,PEntityOfEntIndex在L4D2已经废弃,先不要了
...
void CServerGameEnts::CheckTransmit( CCheckTransmitInfo *pInfo, const unsigned short *pEdictIndices, int nEdicts )
{
	...
	// 以下是代替PEntityOfEntIndex的内联代码,参见
	// https://wiki.alliedmods.net/Porting_to_Left_4_Dead
	//if (gpGlobals->maxEntities > 0)
	//{
	//	edict_t* pBaseEdict = (edict_t*)(gpGlobals->pEdicts + 0);
	//}
	edict_t* pBaseEdict = (edict_t*)(gpGlobals->pEdicts + 0);
